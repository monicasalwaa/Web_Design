...
<div class="jumbotron">
  <img src="image/cc1rbg.png" alt="foto">
  <div class="desc">
    <h1>Thank you for order, enjoy your sweets!</h1><br><br>
  </div>
  <button onclick="window.location.href='menu.php'" class="btn btn-default btn-lg">MENU</button>
</div>